    ...
    <section id="Testimonials" className="testimonials__section">
      <div className="portfolio__container-box">
        <div className="portfolio__container">
          <p className="subtitle">Client's feedback</p>
          <h2 className="sections__heading">Customer feedback</h2>
        </div>
      </div>
      <div className="portfolio__section-container">
        {data?.testimonial?.map((item) => (
          <div key={item.id} className="testimonials__section-card">
            <div className="testimonials__section-card-review">
            ...
            <div className="testimonials__section-card-author-detail">
              <img src={item.src} alt={item.author_name} />
              <div>
                <p className="text-md testimonials__author-name">
                  {item.author_name}
                </p>
                <p className="text-md testimonials__author-designation">
